<template>
  <div class="wrapper">
    ...
    <div v-show="clicked" class="retry" @click="reSelection">Retry</div>
  </div>
</template>
...
const light1 = new THREE.SpotLight(0xffffff, 40, 50, Math.PI / 15, 1);
light1.castShadow = true;
light1.target.position.set(-0.5, 0, 0);
scene.add(light1);
scene.add(light1.target);
const light2 = new THREE.SpotLight(0xffffff, 40, 50, Math.PI / 15, 1);
